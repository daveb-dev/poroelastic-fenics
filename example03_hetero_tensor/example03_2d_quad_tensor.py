...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 22 17:04:42 2020
...
# Reading Mesh
mesh = Mesh()
XDMFFile("unitsq_quad.xdmf").read(mesh)

# Read bndry marker
bndry = MeshFunction("size_t", mesh, dim=1, value=0)
XDMFFile("unitsq_quad_facet.xdmf").read(bndry)
...
V =FiniteElement("Q-", mesh.ufl_cell(),1,1)
