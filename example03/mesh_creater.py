...
if __name__ == "__main__" :
    ...
    creater.RectangleMesh(point2=(1,1), cellType="quad")
    mesh = creater.mesh
    ...
    creater.save_mesh("unitsq_quad")
    
    # Reading Mesh
    mesh2 = df.Mesh()
    df.XDMFFile("unitsq_quad.xdmf").read(mesh2)
    
    # Read bndry marker
    bndry = df.MeshFunction("size_t", mesh2, dim=1, value=0)
    df.XDMFFile("unitsq_quad_facet.xdmf").read(bndry)
